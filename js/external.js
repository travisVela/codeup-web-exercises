...
var isClassFull = prompt('Is the class full? True or False.');
var classFull = isClassFull === 'true';
var doesScheduleConflict = prompt('Does this conflict with your current schedule? True or False.');
var noConflict = doesScheduleConflict.toLowerCase() === 'false';
var canEnroll = !classFull && noConflict;
